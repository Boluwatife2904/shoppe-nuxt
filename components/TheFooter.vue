    ...
    <footer class="footer">
        ...
        <div class="footer__bottom flex space-between">
            <p class="footer__copyright heading-5">
                ...
                <nuxt-link :to="{ name: 'terms-of-service' }" class="navigation__link navigation__link--light">Terms of
                    use</nuxt-link> and
                <nuxt-link :to="{ name: 'privacy-policy' }" class="navigation__link navigation__link--light">privacy
                    policy</nuxt-link>
            </p>
